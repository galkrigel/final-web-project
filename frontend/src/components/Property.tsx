          ...
          <CardActionArea>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Price: {props.property.price.toString()} $ || Rooms: {props.property.rooms.toString()}
                <p></p>
                Phone Number: {props.property.phoneNumber.phone}
               <p> </p>
                Mobile Number: {props.property.phoneNumber.mobile}
               <p></p>
